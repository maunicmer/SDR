...
class Hardware_tutorial(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hardware Tutorial")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hardware Tutorial")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Hardware_tutorial")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(192000, 56000000, 1000, 1800000, 200)
        ...
        self._tuning_range = Range(70000000, 6000000000, 200000, 102000000, 200)
...
def main(top_block_cls=Hardware_tutorial, options=None):
